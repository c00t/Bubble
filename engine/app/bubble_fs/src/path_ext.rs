...
use dyntls::lazy_static;
use either::Either;
use path_slash::PathExt;

lazy_static! {
    /// The current working directory cached in a mutex.
    pub static ref CWD: PathBuf = std::env::current_dir().expect("The current directory must exist");
}

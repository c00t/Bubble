...
pub mod mimalloc {
    ...
    #[cfg(feature = "tracy_memory")]
    #[global_allocator]
    static GLOBAL_ALLOC: ProfiledAllocator<GlobalMiMalloc> =
        ProfiledAllocator::new(GlobalMiMalloc, 100);
...
pub mod system {
    ...
    extern "C" fn dealloc(ptr: *mut u8, _layout: Layout) {
        #[cfg(feature = "tracy_memory")]
        unsafe {
            GLOBAL_ALLOC.dealloc(ptr, _layout)
        }
        #[cfg(not(feature = "tracy_memory"))]
        unsafe {
            std::alloc::dealloc(ptr, _layout)
        }
    }
    ...
    extern "C" fn alloc_zeroed(layout: Layout) -> *mut u8 {
        #[cfg(feature = "tracy_memory")]
        unsafe {
            GLOBAL_ALLOC.alloc_zeroed(layout)
        }
        #[cfg(not(feature = "tracy_memory"))]
        unsafe {
